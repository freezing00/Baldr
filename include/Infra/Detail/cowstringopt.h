...
#ifndef DAHUA_COW_STRING_OPT_INC_
#define DAHUA_COW_STRING_OPT_INC_
...
template <class Storage, typename Align = DAHUA_DEDUCED_TYPENAME Storage::value_type*>
class CowStringOpt
{
...
#endif // DAHUA_COW_STRING_OPT_INC_
